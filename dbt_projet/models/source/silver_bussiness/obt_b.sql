{% set configs = [
    ...
    {
        "table": "surpermache.silver_technical.orders_technical",
        "columns": """o.order_id,
                        o.store_id,
                        o.order_timestamp,
                        o.payment_method,
    ...
    {
        "table": "surpermache.silver_technical.customers_technical",
    ...
    {
        "table": "surpermache.silver_technical.order_items_technical",
    ...
    {
        "table": "surpermache.silver_technical.product_technical",
    ...
    {
        "table": "surpermache.silver_technical.employees_technical",
    ...
    {
        "table": "surpermache.silver_technical.stores_technical",
